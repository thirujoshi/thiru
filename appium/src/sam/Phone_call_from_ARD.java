...
public class Phone_call_from_ARD
{
	...
	if(driver.findElement(By.xpath("//*[@text='Dialling']")).isDisplayed())
	{
		...
		String m=driver.findElement(By.xpath("//*[contains(@resource-id,'message')]")).getAttribute("text");	
		System.out.println(m);
		driver.findElement(By.xpath("//*[@text='0k']")).click();
